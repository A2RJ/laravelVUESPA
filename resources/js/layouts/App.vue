            ...
            <li class="nav-item">
              <a class="nav-link">
                <router-link
                  ...
                  aria-expanded="false"
                  ><i class="mdi mdi-home menu-icon"></i
                  ><span class="menu-title">Jurnal</span></router-link
                >
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link">
                <router-link
                  ...
                  aria-expanded="false"
                  ><i class="mdi mdi-home menu-icon"></i
                  ><span class="menu-title">Neraca</span></router-link
                >
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link">
                <router-link
                  ...
                  aria-expanded="false"
                  ><i class="mdi mdi-home menu-icon"></i
                  ><span class="menu-title">Aktivitas</span></router-link
                >
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link">
                <router-link
                  ...
                  aria-expanded="false"
                  ><i class="mdi mdi-home menu-icon"></i
                  ><span class="menu-title">Arus Kas</span></router-link
                >
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link">
                <router-link
                  ...
                  aria-expanded="false"
                  ><i class="mdi mdi-home menu-icon"></i
                  ><span class="menu-title">LPD</span></router-link
                >
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link">
                <router-link
                  ...
                  aria-expanded="false"
                  ><i class="mdi mdi-home menu-icon"></i
                  ><span class="menu-title">PAK</span></router-link
                >
              </a>
            </li>
            <li class="nav-item">
