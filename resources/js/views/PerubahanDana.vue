            ...
            <div class="my-5 mb-5">
                <table class="table table-bordered table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                {{
                                    (data.penerimaanZakat + data.amilzakat)
                                        | currency
                                }}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                {{
                                    (data.penerimaanZakat +
                                        data.amilzakat -
                                        data.penyaluranZakat)
                                        | currency
                                }}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                {{
                                    (data.penerimaanInfak + data.amilinfak)
                                        | currency
                                }}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                {{
                                    (data.penerimaanInfak -
                                        data.penyaluranInfak)
                                        | currency
                                }}
                            </td>
                        </tr>
              ...
              <td>{{ data.penerimaanAmil | currency }}</td>
                        ...
                        <tr>
                            ...
                            <td>
                                {{
                                    (data.penerimaanNonHalal -
                                        data.penyaluranNonHalal)
                                        | currency
                                }}
                            </td>
                        </tr>
