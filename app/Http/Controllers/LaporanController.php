...
class LaporanController extends Controller
{
    ...
    public function arusKas()
    {
        return response()->json([
            ...
            'aktivitasKas' => $this->get(5, 4.1) + $this->get(5, 4.2) + $this->get(5, 4.3) + $this->get(18, 1.2) + $this->get(15, 2.3),
    ...
    public function LPD()
    {
        return response()->json([
            ...
            'amilzakat' => $this->get(5, 4.2),
            'amilinfak' => $this->get(5, 4.3),
            'penerimaanlainnya' => $this->get(12) + $this->get(15) + $this->get(18, 1.2),
            'penerimaanAmil' => $this->get(5, 4.1) + $this->get(5, 4.2) + $this->get(5, 4.3) + $this->get(12) + $this->get(15) + $this->get(18, 1.2),
